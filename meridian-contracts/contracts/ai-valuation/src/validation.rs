...
pub fn validate_valuation(value: i128) -> Result<(), ValidationError> { validate_amount(value) }
pub fn validate_model_name(name: &str) -> Result<(), ValidationError> { validate_string_length(name, 1, 128) }
